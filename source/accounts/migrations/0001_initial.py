    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, max_length=3000, null=True, verbose_name='Bio')),
                ('phone', models.CharField(blank=True, max_length=15, null=True, verbose_name='Phone number')),
                ('gender', models.CharField(blank=True, choices=[('m', 'Man'), ('w', 'Woman')], max_length=30, null=True, verbose_name='Gender')),
